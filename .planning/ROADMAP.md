...
- [ ] 02-01-PLAN.md — Trade engine and portfolio API: atomic buy/sell, position upsert, trade log, valued read (wave 1)
- [ ] 02-02-PLAN.md — TEST-01 proof suite: money math, state integrity, and concurrent-trade race safety (wave 2)
