...
**Verification depth scales with `asvs_level`** (see @/Users/hendro/Documents/Projects/finally/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
