...
```
Agent(
  prompt="Read /Users/hendro/Documents/Projects/finally/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/hendro/Documents/Projects/finally/.claude/gsd-core/templates/VALIDATION.md`
